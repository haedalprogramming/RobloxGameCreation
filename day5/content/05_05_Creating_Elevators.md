...
1. **탐색기** 창에서 블록을 선택한 다음 **속성** 창에서,
   ...
   1. **크기**를 **[8,1,4]**로 설정합니다.

1. **탐색기** 창에서 플랫폼을 선택한 다음 <kbd>Ctrl</kbd><kbd>D</kbd> (<kbd>⌘</kbd><kbd>D</kbd>)를 눌러 부품을 복제합니다. 이 복제된 부품은 플랫폼이 위아래로 이동하는 트랙이 됩니다.
1. 메뉴 모음에서 **이동** 도구를 선택한 다음 축 화살표 중 하나를 사용하여 원래 위치에서 복제된 부품을 당겨 두 개체 사이에 작은 간격을 만듭니다.
1. **속성** 창에서,
...
1. **탐색기** 창에서 두 부품을 선택한 다음 <kbd>Ctrl</kbd><kbd>G</kbd> (<kbd>⌘</kbd><kbd>G</kbd>)를 눌러 그룹화합니다.
1. 모델의 이름을 **Elevator**로 변경합니다.
