...
4. **Elastic Deform** 도구를 선택하고 강도를 `.5`로 설정하여 마네킹을 완전히 덮도록 정점의 일부를 늘립니다.
   ...
   2. 접근하기 어려운 영역에 접근하기 위해 마네킹을 숨길 수 있습니다.
      ...
      [![](../img/youtube.png)](https://prod.docsiteassets.roblox.com/assets/art/accessories/creating/Modeling_05.mp4)
...
7. Cloth 도구를 사용하여 메시에 천과 같은 표면을 추가하기 위해 클릭하고 드래그합니다. 변형 강도를 변경하려면 설정을 조정합니다.
   ...
   [![](../img/youtube.png)](https://prod.docsiteassets.roblox.com/assets/art/accessories/creating/Modeling_06.mp4)
...
8. **Elastic Deform**, **Inflate**, **Cloth** 도구를 사용하여 최종적으로 메시를 조정하여 마네킹 위에 원하는 최종 모양으로 배치합니다.
   ...
   [![](../img/youtube.png)](https://prod.docsiteassets.roblox.com/assets/art/accessories/creating/Modeling_07.mp4)
